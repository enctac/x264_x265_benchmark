...
REM =================================================================================
REM ★注意
REM　●QSVに対応している環境と、rigaya氏のQSVEncCが必要です。
REM　　　http://rigaya34589.blog135.fc2.com/
REM　　からQSVEncをダウンロードし、その中のQSVEncCフォルダを
REM　　このバッチのある場所のbinフォルダの下に置いて下さい。
REM　●エンコード対象として指定できるのは、
REM　　QSVEncC.exe --avqsvでハードウェアデコードできる動画ファイルのみです。
REM =================================================================================

REM ベンチマークのタイトル
set benchname=QSVEncC HEVC main10 ICQ

REM 出力ファイル名の冒頭
set outname=QSVEncC_HEVC_main10_ICQ
...
set bindir=.\bin
set encoder=%bindir%\QSVEncC\x64\QSVEncC64.exe
IF NOT "%PROCESSOR_ARCHITECTURE%" == "AMD64" (
 set encoder=%bindir%\QSVEncC\x86\QSVEncC.exe
)

set encopt=--avqsv --codec hevc --profile main10 --icq 16
